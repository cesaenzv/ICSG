...
<div class="page-header">
	<h1>FINANCIAMIENTOS PRIMAS</h1>	
</div>
<div class="row outerDiv">
	<div class="span12">
		<p>
			ICSG es una entidad que financia pólizas revocables de Seguros del Estado S.A. en diferentes ramos basados en los principios de Honestidad, Trabajo en Equipo, Lealtad, Respeto, Cumplimiento y Profesionalismo. El objetivo principal de ICSG es satisfacer las necesidades implícitas y explicitas de los clientes e Intermediarios de Seguros del Estado.
		</p>
		<h2>Modalidades de credito</h2>
		<p>
			Pensando en las necesidades de los clientes, ICSG   ha   definido   dos   modalidades   de crédito:
		</p>
		<dd>
			<dt>Crédito Estándar:</dt>
			<dl><i class="icon-bookmark"></i> Esta línea   de   crédito financia hasta el 75% del valor de las pólizas, con un plazo de 4 a 10 meses.</dl>
