        ...
        <div class="span12">
        	<div class="catchText">
            	<div class="row">
                	<div class="span9">
                    <p>
                      Haz parte de Inversiones Comerciales San German S.A., conoce mas de nuestros productos en esta pagina o contacta con nosotros directamente
                    </p>
                    </div>
                    <div class="span3">
                      <button class="btn-large btn color-bg" onclick="location.href=''">CONTACTENOS</button>
                    </div>
                </div>
            </div>
        </div>
